    ...
    <div className="relative p4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-2 gap-8 p-4">
        <div className="flex flex-col bg-white ">
          <div>
            <h1 className="lg:text-3xl text-xl font-bold capitalize">
              {SelectedCampingId.name}
            </h1>
            <div className="flex text-nowrap items-end space-x-2 mt-2">
              <h1 className="lg:text-2xl text-base font-semibold capitalize">
                {SelectedCampingId.price} DH
              </h1>
              <h1 className="lg:text-2xl text-xl text-gray capitalize">
                /per couple
              </h1>
            </div>
          </div>
          <div className="flex items-center pt-2">
            <span className="flex items-center fnt-semibold">
              ...
              <RiStarSFill size={20} className="mr2 text-yellow-300" />
              <RiStarSFill size={20} className="mr2 text-yellow-300" />
              <div className="text-lg font-bold">(2.6K)</div>
            </span>
          </div>
          <div className="mt-4">
            ...
            <div className="grid grid-cols-2 gap-2 text-left pt-4">
              ...
              <div
                className="text-nowrap font-medium capitalize lg:text-lg"
                id="name"
              >
                {SelectedCampingId.name}
              </div>
              ...
              <label
                htmlFor="location"
                className="text-primary font-semibold lg:text-lg"
              >
                Location
              </label>
              <div
              ...
              <div
                ...
                id="start-date"
              >
                {new Date(SelectedCampingId.start_date).toLocaleDateString(
                  "en-CA"
                )}{" "}
              </div>
              ...
              <div
                ...
                id="end-date"
              >
                {new Date(SelectedCampingId.end_date).toLocaleDateString(
                  "en-CA"
                )}
              </div>
              ...
              <div
                ...
                id="group-members"
              >
                {SelectedCampingId.group_member}
              </div>
        ...
        <div className="flex flex-col items-center">
          <img
            src={SelectedCampingId.image}
            alt="Camping Image"
            className="lg:w-[350px] w[170px] lg:h-[400px] h-[300px] object-cover mt-4 rounded-br-[100px] rounded-bl-[0px] rounded-tl-[100px]"
          />
